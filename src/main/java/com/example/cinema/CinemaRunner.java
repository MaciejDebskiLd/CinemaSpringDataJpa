...
public class CinemaRunner implements CommandLineRunner {
    ...
    private void sessionServiceInvocation(){
        ...
        LOG.info("9. sessionWithId15WithTickets - {}, MovieTitle='{}', Room='{}'", sessionWithId15WithTickets, sessionWithId15WithTickets.getMovie().getTitle(), sessionWithId15.getRoom().getName());
